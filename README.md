...
2. Open `home.html` in your web browser to view the site.
3. Use the navigation links to smoothly scroll between sections.
4. Fill the contact form to see an alert confirmation (note: form submissions are not saved to a server).
